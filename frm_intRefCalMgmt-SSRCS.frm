...
Begin VB.Form frm_intRefCalMgmt 
   ...
   EndProperty
   Icon            =   "frm_intRefCalMgmt-SSRCS.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   ScaleHeight     =   8040
   ScaleWidth      =   11190
   ...
   Begin HexUniControls.ctlUniListBoxXP lst_spxHistory 
      ...
      EndProperty
      TrapTab         =   0   'False
      Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0442
      MultiSelect     =   0
      Sorted          =   0   'False
      HScroll         =   0   'False
      ...
      SelectorStyle   =   -1
      MousePointer    =   0
      MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0462
      ManualStart     =   0   'False
      Columns         =   0
   End
   Begin HexUniControls.ctlUniLabel lbl_newScanTime 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_intRefCalMgmt-SSRCS.frx":047E
      BackColor       =   16777215
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frm_intRefCalMgmt-SSRCS.frx":049E
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":04BE
   End
   Begin HexUniControls.ctlUniLabel lbl_currScanTime 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_intRefCalMgmt-SSRCS.frx":04DA
      BackColor       =   16777215
      ForeColor       =   -2147483630
      Alignment       =   2
      VAlignment      =   1
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frm_intRefCalMgmt-SSRCS.frx":04FA
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":051A
   End
   ...
   Begin HexUniControls.ctlUniFrameXP frame_ref 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0536
      Enabled         =   -1  'True
      BackColor       =   -2147483633
      ForeColor       =   16711680
      Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0572
      VistaStyle      =   -1  'True
      UseShadow       =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0592
      Begin HexUniControls.ctlUniLabel lbl_numRefScans 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":05AE
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   0
         VAlignment      =   1
         ...
         BorderStyle     =   1
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":05CE
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":05EE
      End
      Begin HexUniControls.ctlUniLabel lbl_numScans1 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":060A
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   1
         VAlignment      =   1
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0648
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0668
      End
      Begin HexUniControls.ctlUniLabel lbl_refScanProg 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0684
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   2
         VAlignment      =   1
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":06BE
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":06DE
      End
      Begin HexUniControls.ctlProgressXP prg_refScan 
         ...
         BorderSpace     =   -1  'True
         Spaces          =   -1  'True
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":06FA
         Style           =   -1
         BackStyle       =   -1
         RoundedBorders  =   -1  'True
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":071A
      End
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_startScan 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0736
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frm_intRefCalMgmt-SSRCS.frx":076A
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":078A
   End
   ...
   Begin HexUniControls.ctlUniButtonImageXP cmd_exit 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_intRefCalMgmt-SSRCS.frx":07A6
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frm_intRefCalMgmt-SSRCS.frx":07CE
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":07EE
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_abortScan 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_intRefCalMgmt-SSRCS.frx":080A
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frm_intRefCalMgmt-SSRCS.frx":083E
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":085E
   End
   Begin HexUniControls.ctlUniFrameXP frame_smpl 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_intRefCalMgmt-SSRCS.frx":087A
      Enabled         =   -1  'True
      BackColor       =   -2147483633
      ForeColor       =   16711680
      Tip             =   "frm_intRefCalMgmt-SSRCS.frx":08B0
      VistaStyle      =   -1  'True
      UseShadow       =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":08D0
      Begin HexUniControls.ctlUniLabel lbl_numScans2 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":08EC
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   1
         VAlignment      =   1
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":092A
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":094A
      End
      Begin HexUniControls.ctlUniLabel lbl_smplScanProg 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0966
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   2
         VAlignment      =   1
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":09A0
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":09C0
      End
      Begin HexUniControls.ctlProgressXP prg_smplScan 
         ...
         BorderSpace     =   -1  'True
         Spaces          =   -1  'True
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":09DC
         Style           =   -1
         BackStyle       =   -1
         RoundedBorders  =   -1  'True
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":09FC
      End
      Begin HexUniControls.ctlUniLabel lbl_numSmplScans 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0A18
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   0
         VAlignment      =   1
         ...
         BorderStyle     =   1
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0A38
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0A58
      End
   End
   Begin HexUniControls.ctlUniFrameXP frame_ss 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0A74
      Enabled         =   -1  'True
      BackColor       =   -2147483633
      ForeColor       =   16711680
      Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0AAA
      VistaStyle      =   -1  'True
      UseShadow       =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0ACA
      Begin HexUniControls.ctlUniLabel lbl_serNumber 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0AE6
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   1
         VAlignment      =   1
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0B20
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0B40
      End
      Begin HexUniControls.ctlUniLabel lbl_minWavelen 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0B5C
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   1
         VAlignment      =   1
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0BA0
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0BC0
      End
      Begin HexUniControls.ctlUniLabel lbl_maxWavelen 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0BDC
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   1
         VAlignment      =   1
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0C20
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0C40
      End
      Begin HexUniControls.ctlUniLabel lbl_spxCorrFilename 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0C5C
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   1
         VAlignment      =   1
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0CAA
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0CCA
      End
      Begin HexUniControls.ctlUniLabel lbl_serNum 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0CE6
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   0
         VAlignment      =   1
         ...
         BorderStyle     =   1
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0D06
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0D26
      End
      Begin HexUniControls.ctlUniLabel lbl_minWvln 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0D42
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   0
         VAlignment      =   1
         ...
         BorderStyle     =   1
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0D62
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0D82
      End
      Begin HexUniControls.ctlUniLabel lbl_maxWvln 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0D9E
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   0
         VAlignment      =   1
         ...
         BorderStyle     =   1
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0DBE
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0DDE
      End
      Begin HexUniControls.ctlUniLabel lbl_spxCorrFile 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0DFA
         BackColor       =   -2147483633
         ForeColor       =   -2147483630
         Alignment       =   0
         VAlignment      =   1
         ...
         BorderStyle     =   1
         AutoSize        =   0   'False
         Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0E1A
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0E3A
      End
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_updateCalib 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0E56
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0E9A
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0EBA
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_restoreCalib 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0ED6
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frm_intRefCalMgmt-SSRCS.frx":0F1C
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frm_intRefCalMgmt-SSRCS.frx":0F3C
   End
   ...
   Begin HexUniControls.ctlUniFormCaption uniTitle 
      ...
      _ExtentX        =   794
      _ExtentY        =   794
      Caption         =   "frm_intRefCalMgmt-SSRCS.frx":0F58
   End
...
#Else
  If (SpxFileIF.LoadCorrectionFile(dirname, m_spxCorFile, m_scanStartWvln, m_scanEndWvln, MS11CfgData.wvlnIncr, unity_main.m_sys2500, m_corrNumRecs) = True) Then
    rc = SpxFileIF.GetCorrectionSpectra(unity_main.m_sys2500, m_corrReferVals(0), VarPtr(m_corrReferTimeT2), m_corr2ndOrderVals(0), VarPtr(m_corr2ndOrderTimeT2))
  End If
#End If
...
#Else
  If (SpxFileIF.UpdateCorrectionFile(unity_main.m_sys2500, updReferVals(0), VarPtr(timeT2Refer), numScansRefer, upd2ndOrderVals(0), VarPtr(timeT22ndOrder), numScans2ndOrder) = True) Then
    ' Close spectra correction file
    SpxFileIF.CloseCorrectionFile
#End If
...
#Else
  If (SpxFileIF.LoadHistoryFile(dirname, fileName, m_scanStartWvln, m_scanEndWvln, MS11CfgData.wvlnIncr, unity_main.m_sys2500, m_histNumRecs) = True) Then
    Dim timeStrg As String
    lst_spxHistory.Clear

    For ii = 0 To m_histNumRecs - 1
      If (SpxFileIF.GetHistoryTimeT2(ii, unity_main.m_sys2500, VarPtr(m_histReferTimeT2), VarPtr(m_hist2ndOrderTimeT2)) = True) Then
        If (SpxFileIF.CnvtTimeT2Strg(VarPtr(m_histReferTimeT2), timeStrg) = True) Then
          lst_spxHistory.AddItem timeStrg
          rc = True
        Else
          rc = False
...
#Else
  rc = SpxFileIF.UpdateHistoryFile(unity_main.m_sys2500, updReferVals(0), vpTimeT2Refer, numScansRefer, upd2ndOrderVals(0), vpTimeT22ndOrder, numScans2ndOrder)
#End If
...
#Else
      SpxFileIF.GetTimeT2 VarPtr(m_refUpdTimeT2)
#End If
...
#Else
      SpxFileIF.GetTimeT2 VarPtr(m_smplChkTimeT2)
#End If
    Else    ' performing update calibration function
...
#Else
        SpxFileIF.GetTimeT2 VarPtr(m_smplReferTimeT2)
#End If
...
#Else
        SpxFileIF.GetTimeT2 VarPtr(m_smpl2ndOrderTimeT2)
#End If
...
#Else
  ' Create SPX dat file to store 2500 sampled calibration spectra
  rc = SpxFileIF.CreateDatFile(filePath, fileName, m_scanStartWvln, m_scanEndWvln, MS11CfgData.wvlnIncr, -1)
#End If
...
#Else
  ' Update SPX dat file with 2500 sampled calibration spectra
  rc = SpxFileIF.UpdateDatFile(filePath, fileName, recIndx, updVals(0), VarPtr(timT2), NUM_RECAL_SCANS)
#End If
...
#Else
  ' Create batch file to perfrom math treatment on 2500 spectral file
  rc = SpxFileIF.Create2500MathTreatBatFile(filePath, batFileName, spxFileName, m_spxCorFile, recalFileName)
  
  If (rc = True) Then
    ' Perform math treatment on 2500 spectral file
    rc = SpxFileIF.Apply2500MathTreat(filePath, batFileName, recalFileName)
  End If
#End If
...
#Else
  ' Get 2500 math treated spectra data
  rc = SpxFileIF.GetDatSpectra(filePath, fileName, 0, unity_main.m_sys2500, m_smplUpdReferVals(0), VarPtr(t2Refer), m_smplUpd2ndOrderVals(0), VarPtr(t22ndOrder))
#End If
...
#Else
  ' Delete 2500 batch file
  SpxFileIF.DeleteFile filePath, batFileName

  ' Delete 2500 calibration spectra file
  SpxFileIF.DeleteFile filePath, spxFileName

  ' Delete 2500 recalibration spectra file
  SpxFileIF.DeleteFile filePath, recalFileName
  rc = True
#End If
...
Private Sub init_scan_info()
  ...
  m_smplTrayNum = 1 ' change from 3 was causing issue on static top ' B&L small cup
...
#Else
  SpxFileIF.CnvtTimeT2Strg vpTimeT2, timeStrg
#End If
...
#If SSRCS Then
  ...
  End If
#Else
  lastErrCode = SpxFileIF.LastErrorCode
  lastSpxErrCode = SpxFileIF.LastSpxErrorCode
#End If
...
#Else
      corStartWvln = SpxFileIF.CorrStartWvln
      corEndWvln = SpxFileIF.CorrEndWvln
      corWvlnIncr = SpxFileIF.CorrWvlnIncr
#End If
...
#Else
      hstStartWvln = SpxFileIF.HistStartWvln
      hstEndWvln = SpxFileIF.HistEndWvln
      hstWvlnIncr = SpxFileIF.HistWvlnIncr
#End If
...
#If SSRCS Then
    ...
    If (SSRCSClientError = 0) Then
#Else
    If (SpxFileIF.GetHistorySpectra(indx, unity_main.m_sys2500, m_histReferVals(0), VarPtr(m_histReferTimeT2), m_histNumReferScans, m_hist2ndOrderVals(0), VarPtr(m_hist2ndOrderTimeT2), m_histNum2ndOrderScans) = True) Then
#End If
