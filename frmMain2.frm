...
Object = "{6435ECF4-AAEF-4D11-9585-E7322687532C}#1.0#0"; "MS11srv.ocx"
...
Begin VB.Form unity_main 
   ...
   Begin HexUniControls.ctlUniButtonImageXP cmd_verifyRef 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":0BD4
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frmMain2.frx":0C14
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":0C34
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_runBatch 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":0C50
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frmMain2.frx":0C82
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":0CA2
   End
   Begin VB.Timer tmr_autoSmplrCommRsp 
      ...
      Top             =   10440
   End
   Begin VB.PictureBox msComm_autoSmplr 
      Height          =   480
      Left            =   5160
      ScaleHeight     =   420
      ScaleWidth      =   1140
   ...
   Begin HexUniControls.ctlUniButtonImageXP cmd_clientAppl 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":28AE
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frmMain2.frx":28CE
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":28EE
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_clientAppl 
      Height          =   700
      Index           =   1
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":290A
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frmMain2.frx":292A
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":294A
   End
   Begin HexUniControls.ctlUniLabel lbl_sampleName 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frmMain2.frx":2994
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":29B4
   End
   Begin HexUniControls.ctlUniTextBoxXP txtsamplename 
      ...
      Tip             =   "frmMain2.frx":29F0
      NoHideSel       =   0   'False
      RightToLeft     =   0   'False
      ManualStart     =   0   'False
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":2A10
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_ref 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":2A2C
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frmMain2.frx":2A52
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":2A72
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_bias 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":2A8E
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frmMain2.frx":2AB6
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":2AD6
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_exit 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":2AF2
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frmMain2.frx":2B1A
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":2B3A
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_options 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":2B56
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frmMain2.frx":2B84
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":2BA4
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_sample 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":2BC0
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frmMain2.frx":2BF6
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":2C16
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_select 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":2C32
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frmMain2.frx":2C6E
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":2C8E
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_repacks 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":2CAA
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frmMain2.frx":2CD8
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":2CF8
   End
   ...
   Begin HexUniControls.ctlUniLabel lbl_cursorValue 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frmMain2.frx":2D34
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":2D54
   End
   Begin HexUniControls.ctlUniLabel lbl_scanDateTime 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frmMain2.frx":2D90
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":2DB0
   End
   Begin HexUniControls.ctlUniLabel lbl_opStatus 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frmMain2.frx":2DEC
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":2E0C
   End
   Begin FPUSpreadADO.fpSpread ss_last50 
      ...
      SpreadDesigner  =   "frmMain2.frx":2E28
      UnitType        =   2
      UserResize      =   1
   End
   Begin HexUniControls.ctlUniLabel lbl_time 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frmMain2.frx":3136
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":3156
   End
   Begin HexUniControls.ctlUniLabel lbl_date 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frmMain2.frx":3192
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":31B2
   End
   Begin HexUniControls.ctlUniLabel lbl_backdate 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frmMain2.frx":31EE
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":320E
   End
   Begin HexUniControls.ctlUniLabel lbl_sampleComment 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frmMain2.frx":3258
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":3278
   End
   ...
   Begin HexUniControls.ctlUniFrameXP Frame1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":3438
      Enabled         =   -1  'True
      BackColor       =   12632064
      ForeColor       =   -2147483640
      Tip             =   "frmMain2.frx":3458
      VistaStyle      =   -1  'True
      UseShadow       =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":3478
      Begin HexUniControls.ctlUniImage ctlUniImage1 
         ...
         _ExtentX        =   2619
         _ExtentY        =   1879
         Picture         =   "frmMain2.frx":3494
         Tip             =   "frmMain2.frx":78838
         Enabled         =   -1  'True
         Border          =   0   'False
         BackColor       =   12632064
         BorderColor     =   -1
      ...
      Begin HexUniControls.ctlUniLabel lblSysDateTime 
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frmMain2.frx":788BA
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frmMain2.frx":788DA
      End
      Begin HexUniControls.ctlUniLabel lbl_movement 
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frmMain2.frx":78916
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frmMain2.frx":78936
      End
      Begin HexUniControls.ctlUniLabel lblMovementTitle 
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frmMain2.frx":78992
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frmMain2.frx":789B2
      End
      Begin HexUniControls.ctlUniLabel lblSampleModeTitle 
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frmMain2.frx":78A0E
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frmMain2.frx":78A2E
      End
      Begin HexUniControls.ctlUniLabel lbl_samplemode 
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frmMain2.frx":78A6A
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frmMain2.frx":78A8A
      End
      Begin HexUniControls.ctlUniLabel lblProd1 
         ...
         BorderStyle     =   0
         AutoSize        =   0   'False
         Tip             =   "frmMain2.frx":78AC6
         Style           =   0
         Enabled         =   -1  'True
         Margin          =   0
         RoundedBorders  =   0   'False
         MousePointer    =   0
         MouseIcon       =   "frmMain2.frx":78AE6
      End
   ...
   Begin HexUniControls.ctlUniButtonImageXP cmd_start 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":78B7C
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frmMain2.frx":78BA6
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":78BC6
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_stop 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frmMain2.frx":78BE2
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frmMain2.frx":78C0A
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":78C2A
   End
   Begin HexUniControls.ctlUniTextBoxXP txtsampcomment 
      ...
      EnableContextMenu=   -1  'True
      RaiseChangeEvent=   -1  'True
      Tip             =   "frmMain2.frx":78C66
      NoHideSel       =   0   'False
      RightToLeft     =   0   'False
      ManualStart     =   0   'False
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":78C86
   End
   ...
   Begin HexUniControls.ctlUniLabel lbl_miltime 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frmMain2.frx":78D3A
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frmMain2.frx":78D5A
   End
   Begin MS11SRVLib.MS11srv MS11srv 
      Height          =   375
      Left            =   11280
      TabIndex        =   27
      TabStop         =   0   'False
   ...
   Begin FPUSpreadADO.fpSpread fpspread_pred 
      ...
      RetainSelBlock  =   0   'False
      SelectBlockOptions=   0
      SpreadDesigner  =   "frmMain2.frx":78DEE
      UnitType        =   2
      UserResize      =   1
   End
...
Public m_intRefVerifyRemindTime As Double
...
Public m_intRefVerifyAccumTime As Double
Public m_intRefStartTime As Single
...
' Auto sampler/batch run variables
...
#If SSTAR Then
  ...
  unity_main.m_allowIntRefCalAccess = True
    ...
    If ((MS11CfgData.sysScanMode And &HC00) = &HC00) Then
      ...
      If (m_intRefVerifyTimeout > 0) Then
        m_intRefVerifyTimer = Timer
      End If
    End If
  End If
  ' get an initial time on start up.
  m_intRefStartTime = Timer
...
t = StartTime + intvTimeSecs
  ...
  End If
End Function
Public Function chk_timeoutMine(StartTime As Single, intvTimeSecs As Single) As Boolean
  Dim currTime As Single
  
  chk_timeoutMine = False
  currTime = Timer
Dim t As Single
t = StartTime + intvTimeSecs

 If (currTime < StartTime) Then
  chk_timeoutMine = True
  
  ElseIf (currTime > StartTime) Then
    If (currTime > (StartTime + intvTimeSecs)) Then
      chk_timeoutMine = True
    End If
  Else
...
Sub kill_loop(ByVal dbgLevel As LOG_DBG_LEVELS, resetCtr As Boolean, reasonMsg As String)
 ...
 ' SetSafeFocus (unity_main.cmd_sample)
...
Sub restart_loop(ByVal dbgLevel As LOG_DBG_LEVELS, reasonMsg As String)
  ...
  cmd_sample.enabled = True
  If cmd_sample.Visible And cmd_sample.enabled Then
    'unity_main.cmd_sample.SetFocus
  End If
  If (unity_main.m_intRefPPTScan = True) Or (unity_main.m_extRefPPTScan = True) Then
...
Public Sub setup_scan_mode()
  ...
  ' Check if not performing internal reference calibration function
  If (unity_main.m_intRefCalFlg = False) Then ' was false
  ...
  If (m_ms11srvGNEventQ.Count <> 0) Then
    ...
    Select Case (gnEvent.noticeType)
      ...
      Case EVGN_SMPLSCNBAD        ' Sample Data Scan Collected but Bad (Clipped or Failed PPT Qualification)
        ...
        If (gnEvent.lastErrCode = LAST_ERRORS.LEC_BADSPECD) Then
...
OBJECT_ERROR:
  unity_main.m_ansiErrMsg = "Standardized Spectrum:Unity PRDComponent.dll component not installed or registered"
...
Private Sub chk_ucal_files_installed()
  ...
  fileName = "PRDComponentEnc.dll"
  fileFound1 = CFile.st_FileExist(dirname & fileName)
  
  'MsgBox (fileFound1)
  fileName = "SVFComponentEnc.dll"
  fileFound2 = CFile.st_FileExist(dirname & fileName)
  'MsgBox (fileFound2)
...
PRD_OBJECT_ERROR:
  unity_main.errorstring = "chk_ucal_files_installed:Unity PRDComponentEnc.dll component not installed or registered"
  unity_main.write_error
...
SVF_OBJECT_ERROR:
  unity_main.errorstring = "chk_ucal_files_installed:Unity SVFComponentEnc.dll component not installed or registered"
  unity_main.write_error
  uniMsg = MLSupport.GGS_Params("errMsg7", "Unity %1 component not installed or registered", "SVFComponent.dll")
  CWrap.ShowMessageBoxW MLSupport.GGS_Params("errMsg1", "%1. Please contact your supervisor!", uniMsg), vbCritical
End Sub
      ...
      If (unity_main.m_backFreq = REF_FREQ_ON_DEMAND) Then
        ...
        If (unity_main.m_intRefTimeout > 0) Then
          ...
          If (MS11srv.refTimeout > 0) Then
            unity_main.lbl_backdate.Caption = MLSupport.GGS_Params("unity_main.lbl_backdate_int", "Internal Reference Expires in %1 Minute(s)", MS11srv.refTimeout)
          Else
            unity_main.lbl_backdate.Caption = MLSupport.GSS("unity_main", "lbl_backdate_int2", "Internal Reference has Expired")
          End If
        Else
...
Private Sub tmr_sec30_Timer() ' actually a 1 minute timer
#If SSTAR Then
    ' Check if configured for internal reference checking
