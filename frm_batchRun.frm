...
Object = "{8DE5B8DC-0E8E-406B-A81B-C0874223E2EF}#52.0#0"; "AutoSamplerComm.ocx"
...
Begin VB.Form frm_batchRun 
   ...
   Begin FPUSpreadADO.fpSpread ss_batchInfo 
      ...
      SpreadDesigner  =   "frm_batchRun.frx":0000
      UserResize      =   1
   End
   Begin HexUniControls.ctlUniListBoxExXP lst_towersInUse 
      ...
      SelectorStyle   =   -1
      MousePointer    =   0
      MouseIcon       =   "frm_batchRun.frx":0286
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_abortBatch 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_batchRun.frx":02A2
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frm_batchRun.frx":02D8
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frm_batchRun.frx":02F8
   End
   ...
   Begin HexUniControls.ctlUniButtonImageXP cmd_exit 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_batchRun.frx":0314
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frm_batchRun.frx":033C
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frm_batchRun.frx":035C
   End
   Begin HexUniControls.ctlUniLabel lbl_scanProgress 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frm_batchRun.frx":03B2
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frm_batchRun.frx":03D2
   End
   Begin HexUniControls.ctlProgressXP scanProgress 
      ...
      BorderSpace     =   -1  'True
      Spaces          =   -1  'True
      Tip             =   "frm_batchRun.frx":03EE
      Style           =   -1
      BackStyle       =   -1
      RoundedBorders  =   -1  'True
      MousePointer    =   0
      MouseIcon       =   "frm_batchRun.frx":040E
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_batchReport 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_batchRun.frx":042A
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frm_batchRun.frx":0462
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frm_batchRun.frx":0482
   End
   Begin HexUniControls.ctlUniLabel lbl_batchProgress 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frm_batchRun.frx":04DA
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frm_batchRun.frx":04FA
   End
   Begin HexUniControls.ctlUniLabel lbl_batchProgress2 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frm_batchRun.frx":0536
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frm_batchRun.frx":0556
   End
   Begin HexUniControls.ctlUniLabel lbl_batchName 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frm_batchRun.frx":05A6
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frm_batchRun.frx":05C6
   End
   Begin HexUniControls.ctlUniLabel lbl_batchNameFile 
      ...
      BorderStyle     =   1
      AutoSize        =   0   'False
      Tip             =   "frm_batchRun.frx":0602
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frm_batchRun.frx":0622
   End
   Begin HexUniControls.ctlUniLabel lbl_autoSamplrVer 
      ...
      BorderStyle     =   0
      AutoSize        =   0   'False
      Tip             =   "frm_batchRun.frx":065E
      Style           =   0
      Enabled         =   -1  'True
      Margin          =   0
      RoundedBorders  =   0   'False
      MousePointer    =   0
      MouseIcon       =   "frm_batchRun.frx":067E
   End
   Begin HexUniControls.ctlUniButtonImageXP cmd_emergencyStop 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "frm_batchRun.frx":069A
      BackColor       =   -2147483633
      ForeColor       =   -2147483630
      ShowFocus       =   -1  'True
      Tristate        =   0   'False
      Pressed         =   0   'False
      Tip             =   "frm_batchRun.frx":06D6
      Style           =   -1
      RoundedBorders  =   -1  'True
      xTranspColor    =   0
      yTranspColor    =   0
      MousePointer    =   0
      MouseIcon       =   "frm_batchRun.frx":06F6
   End
   Begin AutoSamplerCommCtrl.AutoSamplerComm autoSmplr 
      Height          =   735
      Left            =   8880
      TabIndex        =   6
      Top             =   1440
